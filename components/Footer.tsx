...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-gray-900 text-gray-400 py-8 border-t border-gray-800 animate-fade-in" id="main-footer">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="text-xs text-gray-600 flex flex-col sm:flex-row justify-center items-center gap-4">
                    <button 
