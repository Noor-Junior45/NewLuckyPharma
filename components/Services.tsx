...
const Services: React.FC = () => {
    return (
        // Start: Medical-50 (Matches Products End) -> Via: Blue-100 -> End: White
        <section id="services" className="py-16 scroll-mt-24 bg-gradient-to-b from-medical-50 via-blue-100 to-white">
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="md:w-1/2 reveal group overflow-hidden rounded-3xl animate-fade-in shadow-2xl border-4 border-white">
                        <img 
                    ...
                    <div className="md:w-1/2">
                        ...
                        <ul className="space-y-6">
                            <li className="flex items-start reveal reveal-delay-100 hover:translate-x-2 transition-transform duration-300 cursor-default p-4 rounded-2xl hover:bg-white/60 glass-card border-none shadow-sm">
                            ...
                            <li className="flex items-start reveal reveal-delay-200 hover:translate-x-2 transition-transform duration-300 cursor-default p-4 rounded-2xl hover:bg-white/60 glass-card border-none shadow-sm">
                            ...
                            <li className="flex items-start reveal reveal-delay-300 hover:translate-x-2 transition-transform duration-300 cursor-default p-4 rounded-2xl hover:bg-white/60 glass-card border-none shadow-sm">
