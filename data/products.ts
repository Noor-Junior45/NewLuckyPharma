...
export const productList: Product[] = [
    ...
    { 
        ...
        category: 'Homeopathy',
        composition: 'Natural Extracts, Herbal Dilutions (Alcohol based)',
    ...
    { 
        ...
        composition: 'Amoxycillin (500mg) / Azithromycin (500mg)',
    ...
    { 
        ...
        composition: 'Various formulations (Diclofenac, Pantoprazole, etc.)',
    ...
    { 
        ...
        delay: 'reveal-delay-300',
        category: 'Wellness',
        composition: 'Vitamin A, B-Complex, C, D, E, Zinc, Magnesium',
    ...
    { 
        ...
        composition: 'Bacteriostatic Formula, Cooling Agents',
    ...
    },
    {
        id: 16,
        name: 'Digene Gel',
        description: 'Digene Gel provides effective and long-lasting relief from acidity, gas, heartburn, and bloating. Its scientifically developed formula neutralizes excess stomach acid and coats the stomach lining for quick comfort.',
        image: 'https://cdn01.pharmeasy.in/dam/products_otc/I35832/digene-gel-acidity-gas-relief-200ml-mixed-fruit-flavour-sugar-free-2-1710940171.jpg',
        delay: 'reveal-delay-100',
        category: 'Stomach Care',
        composition: 'Magnesium Hydroxide, Simethicone, Sodium Carboxymethylcellulose',
        usage: 'Take 2 teaspoonfuls after meals or as required.',
        sideEffects: 'None usually. In rare cases, loose stools.',
        precautions: ['Shake well before use.', 'Keep out of reach of children.', 'Diabetics should use sugar-free version.'],
        isPrescriptionRequired: false
    },
    {
        id: 17,
        name: 'Dettol Antiseptic Liquid',
        description: 'Dettol Antiseptic Liquid provides trusted protection against germs and bacteria. It is essential for first aid to clean cuts, scratches, and insect bites, and can also be used for personal hygiene and household disinfection.',
        image: 'https://ik.imagekit.io/wlfr/wellness/images/products/203545-1.jpg/tr:w-3840,c-at_max,cm-pad_resize,ar-1210-700,pr-true,f-auto,q-70,l-image,i-Wellness_logo_BDwqbQao9.png,lfo-bottom_right,w-200,h-90,c-at_least,cm-pad_resize,l-end',
        delay: 'reveal-delay-200',
        category: 'First Aid',
        composition: 'Chloroxylenol (4.8%)',
        usage: 'Dilute in water for wound cleaning, bathing, or surface disinfection.',
        sideEffects: 'Skin irritation if used undiluted.',
        precautions: ['Do not use undiluted on skin.', 'Avoid contact with eyes.', 'For external use only.'],
        isPrescriptionRequired: false
    },
    {
        id: 18,
        name: 'Stayfree Secure',
        description: 'Stayfree Secure sanitary pads provide superior long-lasting protection during menstruation. Features a leak-lock technology and cottony soft cover for leak-free comfort and hygiene.',
        image: 'https://www.bbassets.com/media/uploads/p/xl/264105_22-stayfree-secure-cottony-soft-sanitary-pads-with-wings.jpg',
        delay: 'reveal-delay-300',
        category: 'Personal Care',
        composition: 'Absorbent Polymer Core, Soft Cottony Cover',
        usage: 'Use as required during menstruation. Change every 4-6 hours.',
        sideEffects: 'None. Discontinue if rash occurs.',
        precautions: ['Wrap used pads in paper and throw in dustbin.', 'Do not flush.'],
        isPrescriptionRequired: false
    },
    {
        id: 19,
        name: 'Pudin Hara',
        description: 'Dabur Pudin Hara is an Ayurvedic remedy for quick relief from stomach ache, gas, and indigestion. Enriched with peppermint oil (Pudina Satva), it provides a cooling effect and soothes the digestive system naturally.',
        image: 'https://www.ayurplan.com/wp-content/uploads/2023/11/pudin-hara-active-1-strip-by-dabur-image-1.jpg',
        delay: 'reveal-delay-100',
        category: 'Stomach Care',
        composition: 'Mentha Piperita (Peppermint Oil)',
        usage: 'Take 1-2 pearls after meals with a glass of water.',
        sideEffects: 'Mild throat burning if capsule breaks in mouth.',
        precautions: ['Swallow whole; do not chew.', 'Not for infants.'],
        isPrescriptionRequired: false
    },
    {
        id: 20,
        name: 'Protinex',
        description: 'Protinex is a high-quality protein supplement that helps build muscle mass, strength, and immunity. Fortified with essential vitamins and minerals, it is the perfect daily nutritional partner for a healthy and active lifestyle.',
        image: 'https://www.protinex.com/wp-content/themes/protinex/assets/images/serving-sixty-img.png',
        delay: 'reveal-delay-200',
        category: 'Nutrition',
        composition: 'Hydrolysed Peanut Protein, Vitamins, Minerals',
        usage: 'Mix 2-3 tablespoons in a glass of milk or water.',
        sideEffects: 'Bloating or gas if lactose intolerant (take with water).',
        precautions: ['Contains peanut/soy ingredients.', 'Diabetics should choose the sugar-free variant.'],
        isPrescriptionRequired: false
    },
    {
        id: 21,
        name: 'Zandu Balm',
        description: 'Zandu Balm is India\'s No.1 Ayurvedic pain relief balm. It provides instant and long-lasting relief from headaches, body aches, and cold. Trusted by millions for its effective natural formulation.',
        image: 'https://m.media-amazon.com/images/I/718dqbuaIpL.jpg',
        delay: 'reveal-delay-300',
        category: 'Pain Relief',
        composition: 'Menthol, Gaultheria Oil, Ayurvedic Ingredients',
        usage: 'Apply gently on the forehead or affected muscles.',
        sideEffects: 'Mild burning sensation (cooling effect).',
        precautions: ['Avoid contact with eyes.', 'Do not apply on open wounds.', 'For external use only.'],
        isPrescriptionRequired: false
    },
    {
        id: 22,
        name: 'Boroline',
        description: 'Boroline is a trusted antiseptic boric cream that works wonders for dry skin, cracked lips, cracked heels, and minor cuts. Its rich lanolin-based formula ensures deep moisturization and rapid healing.',
        image: 'https://upload.wikimedia.org/wikipedia/commons/9/9e/Boroline_Antiseptic_Cream.jpg',
        delay: 'reveal-delay-100',
        category: 'Skin Care',
        composition: 'Boric Acid, Zinc Oxide, Lanolin',
        usage: 'Apply on dry skin, lips, or minor cuts at night.',
        sideEffects: 'None.',
    ...
    },
    {
        id: 23,
        name: 'Eno',
        description: 'Eno gets to work in 6 seconds to neutralize excess stomach acid and provide instant relief from acidity, heartburn, and bloating. A fast-acting effervescent powder available in various flavors.',
        image: 'https://cpimg.tistatic.com/8262492/b/1/eno-3-flavour.jpg',
        delay: 'reveal-delay-200',
        category: 'Stomach Care',
        composition: 'Sodium Bicarbonate, Citric Acid, Sodium Carbonate',
        usage: 'Dissolve one sachet in a glass of water and drink immediately.',
        sideEffects: 'Belching (Burping).',
        precautions: ['Do not take if you have high blood pressure (contains salt).', 'Maximum 2 doses per day.'],
        isPrescriptionRequired: false
    },
    {
        id: 24,
        name: 'Revital H',
        description: 'Revital H is a daily health supplement with a combination of 10 Vitamins, 9 Minerals, and Ginseng which helps in improving physical and mental performance and supports high energy levels throughout the day.',
        image: 'https://m.media-amazon.com/images/I/71Y87K62b9L.jpg',
        category: 'Nutrition',
        composition: 'Ginseng, Vitamin A, B1, B2, B3, B6, B12, C, D3, E, Folic Acid, Calcium, Phosphorus, Zinc, Iron, Magnesium, Potassium, Manganese, Copper, Iodine',
        usage: 'One capsule daily after a meal.',
        sideEffects: 'Occasional mild stomach discomfort.',
        precautions: ['Do not take on an empty stomach.', 'Not recommended for children.'],
        isPrescriptionRequired: false
    },
    {
        id: 25,
        name: 'Cetiriz (Cetirizine)',
        description: 'Cetiriz (containing Cetirizine) is a highly effective, non-sedating antihistamine used to provide rapid relief from allergy symptoms such as sneezing, runny nose, itchy or watery eyes, and skin rashes (hives). It works by blocking histamine, a natural substance in the body that causes allergic reactions.',
        image: 'https://cdn01.pharmeasy.in/dam/products_otc/035100/cetiriz-tablet-10s-2-1671740924.jpg',
        delay: 'reveal-delay-300',
        category: 'Allergy & Cold',
        composition: 'Cetirizine Hydrochloride (10mg)',
        usage: 'Relief from runny nose, sneezing, itchy eyes, and hives. One tablet daily.',
        sideEffects: 'Mild drowsiness, dry mouth, or headache.',
        precautions: ['Do not exceed one tablet in 24 hours.', 'Caution during driving if drowsiness occurs.', 'Consult a doctor if you have kidney problems.'],
        isPrescriptionRequired: false
    }
];